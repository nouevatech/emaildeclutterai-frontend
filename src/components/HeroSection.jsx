...
export const HeroSection = () => {
  return (
    <main className="grid grid-col-1  lg:grid-cols-2 gap-x-8 justify-between  items-center px-8 lg:px-24 py-10">
      <div className="flex flex-col justify-center">
        ...
        <p className="text-[#666666] text-base lg:text-xl max-w-[500px] mb-8">
        ...
        <div className="flex gap-4">
          ...
          <a
            ...
            href="#"
            className="flex items-center gap-x-2 border border-black text-black px-8 py-2 rounded-lg font-medium "
          >
            Watch Demo{" "}
            <span>
